cc.Class({
    ...
    onLoad () {
        ...
        this._storagePath = ((jsb.fileUtils ? jsb.fileUtils.getWritablePath() : '/') + 'xianwanhudong');
    ...
    startUpdate (gameName) {
        this.gameName = gameName;
        this.loadChildGameManifest(gameName);
        this.checkUpdate();
    },

    // var path = "res/raw-assets/module/game/";
    loadChildGameManifest (gameName) {
        // var path = "res/raw-assets/module/game/" + gameName + "/" + gameName + ".manifest";
        var path = "resources/childGameManifest/" + gameName + ".manifest";
        this.manifestUrl = cc.url.raw(path);
    },
    ...
    updateCallBack (event) {
        ...
        switch (event.getEventCode())
        {
            ...
            case jsb.EventAssetsManager.UPDATE_PROGRESSION:
                ...
                // this.label_percent.string = event.getDownloadedFiles() + ' / ' + event.getTotalFiles();
                this.label_percent.string = event.getDownloadedBytes() + ' / ' + event.getTotalBytes();
            ...
            case jsb.EventAssetsManager.UPDATE_FINISHED:
                ...
                cc.sys.localStorage.setItem(this.gameName, true);
                this.setSearchPaths();
                this.node.destroy();
                // needRestart = true;
                break;
