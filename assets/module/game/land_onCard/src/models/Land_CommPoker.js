...
cc.Class({
    ...
    unselected: function () {
        if (this.selected) {
            ...
            this.node.runAction(cc.moveTo(0.1, cc.p(this.node.x, this.node.y - 30)))
        }
        this.selected = false;
    ...
    doselect: function () {
        ...
        if (this.selected == false) {
            ...
            // this.maskLayout.runAction(cc.moveTo(1, cc.p(this.maskLayout.x, this.maskLayout.y + 30)));
            // this.maskLayoutbg.runAction(cc.moveTo(1, cc.p(this.maskLayoutbg.x, this.maskLayoutbg.y + 30)))
